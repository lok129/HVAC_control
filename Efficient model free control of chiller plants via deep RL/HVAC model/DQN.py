...
EPS_DECAY_ratio = 0.0007#差不多200步之后不再探索
LearnStep = 0
episodes        = 20
...
class DQN:
    ...
    #     Agent = choose_tchws(2, 10, self.action)
    #     summary(Agent.policy_net, input_size=(2,),batch_size=32)
...
if __name__ == "__main__":
    DQN = DQN()
    # DQN.print_model_summary()
    # DQN.print_model_parameters()
